...
var JobManager = module.exports = function JobManager(options){
    ...
    this.processTemplate = function(rpcData){
        ...
        var lastJob=null;
        if(lastJobid>0)
            lastJob = this.validJobs[lastJobid.toString(16)];

        this.validJobs = {};
        _this.emit('newBlock', tmpBlockTemplate);

        if(lastJob){
            this.validJobs[lastJobid.toString(16)] = lastJob;
            console.log("lastJob-1:"+JSON.stringify(lastJobid.toString(16)));
        }

        this.validJobs[tmpBlockTemplate.jobId] = tmpBlockTemplate;

        //console.log("log信息:"+JSON.stringify(this.validJobs));
	...
	var shareError = function(error){
        ...
        if (typeof job === 'undefined' || job.jobId != jobId ) {
            ...
            console.log("jobId:"+JSON.stringify(jobId));
            //console.log("validJobs:"+JSON.stringify(this.validJobs));
        ...
        //return shareError([20, 'workerName:'+workerName]);
